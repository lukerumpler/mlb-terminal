...
function normalizeResult(value, fallbackQuery) {
  ...
  const interpretation =
    clean(value?.interpretation, 220) ||
    `No verified destination was identified for “${fallbackQuery}”.`;
  return {
    intent,
    tab,
    entity,
  ...
  return normalizeResult(
    {
      ...
      metric: null,
      interpretation:
        "AI search is unavailable. Use a player name, team name, or a page name and try again.",
      generated: false,
    },
    query
  );
