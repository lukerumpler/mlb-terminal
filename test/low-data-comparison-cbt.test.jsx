      ...
      players: [
        {
          ...
          axes: [
            ...
            { label: "Contact", value: 82 },
          ],
        },
        {
          playerName: "Player B",
          axes: [
            { label: "Power", value: 64 },
            { label: "Contact", value: 101 },
          ],
        },
      ],
      summary: {
        headline: "Player A leads power",
        recommendation: "Choose Player A for impact power.",
        caveat: "Percentiles are source-backed.",
      },
    });
...
describe("CBT repeater-tier tooltip explanations", () => {
  it("explains first, second, third-plus, and unavailable tiers", () => {
    expect(getRepeaterTierExplanation(1)).toMatchObject({
      rate: "20% base rate",
    });
    ...
    expect(getRepeaterTierExplanation(null).detail).toContain(
      "does not provide verified consecutive-year CBT history"
    );
  });
});
