...
describe('contract source accuracy', () => {
  it('does not treat MLB identity or debut metadata as a verified contract record', () => {
    expect(hasVerifiedContractData(null, {
  ...
  it('recognizes a scraped contract value when the source actually returned one', () => {
    expect(hasVerifiedContractData({ source: 'Baseball-Reference', salary: 35000000 }, null)).toBe(true);
    expect(hasVerifiedContractData({ source: 'Spotrac', aav: 45000000, total: null }, null)).toBe(true);
  });
