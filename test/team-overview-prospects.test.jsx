...
const savantSource = fs.readFileSync(
  path.join(projectRoot, "server/api/savant.js"),
  "utf8"
);
...
describe("Team Overview and Prospects enhancement contract", () => {
  ...
  it("connects Exit Velocity Distribution to a team-scoped Savant source", () => {
    ...
    expect(overviewSource).toContain(
      "Baseball Savant Statcast Search · verified roster rollup"
    );
    ...
    expect(savantSource).toContain(
      "team_exit_velocity requires an MLB team abbreviation"
    );
  });
